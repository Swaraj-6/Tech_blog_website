<%-- 
    Document   : profile
    Created on : 05-Nov-2023, 6:35:50 pm
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="#"><span class="fa fa-keyboard-o"></span> Iron Tech <span class="sr-only">(current)</span></a>
                    </li>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="add-post-form" action="AddPostServlet" method="post">
                            ...
                            <div class="form-group">
                                <code><textarea name="pCode" class="form-control" style="height: 200px;" placeholder="Enter your program (if any)"></textarea></code>
                            </div>
                            <div class="form-group">
                                <textarea name="hastags" class="form-control" style="height: 35px;" placeholder="Enter your hastags (if any)"></textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="container text-center">
                                <button type="submit" class="btn secondary-background">Post </button>
                            </div>
        ...
        <script>
            $(Document).ready(function () {
                ...
                $("#add-post-form").on("submit", function (event) {
                    // this code excutes when form is submitted...
