<%-- 
    Document   : index
    Created on : 03-Nov-2023, 11:34:29 am
        ...
        <div class="container-fluid p-0 m-0">
            ...
            <div class="jumbotron primary-background text-light banner-background">
                <div class="container">
                    ...
                    <a href="register_page.jsp" class="btn btn-outline-light btn-lg secondary-background"> <span class="fa fa fa-user-plus"></span>  Start ! its Free</a>
